// generated by PharoJS *** DO NOT EDIT *** on 2019-07-20T09:56:52.382844+02:00 by noury
...
function LoSingleElementRemoveEvent(){};
function PjCollection(){};
function Point(){};
function Margin(){};
function LoSubjectSet(){};
function PjMagnitude(){};
function LoSingleElementChangeEvent(){};
function AssertionFailure(){};
function LjSubjectOrderedCollection(){};
function PjRectangle(){};
function LoSingleElementAddEvent(){};
function PjLookupKey(){};
function LoSingleElementReplaceEvent(){};
function PjDictionary(){};
function PjSet(){};
function LoSubjectDictionary(){};
function LoEvent(){};
...
Object.prototype.$def(function _setTimeout_afterMilliseconds_(aBlock,anInteger){window.setTimeout(aBlock, anInteger)});
...
PjUndefinedObject.prototype.$def(function _identityHash(){return 276177664});
...
return false});
String.prototype.$def(function _includesAll_(aCollection){var $_self_$=this;var $_err_$={};try{$asNil$(aCollection)._do_(function(elem){if(true==$_self_$._includes_(elem))return undefined;else throw $_err_$=false});return true}catch(e){if(e===$_err_$)return e;throw e}});
...
String.prototype.$def(function _isLetter(){return $asNil$(this._letterCharCodes())._includes_(this.charCodeAt(0))});
...
Array.prototype.$def(function _asSubject(){LjSubjectOrderedCollection._adoptInstance_(this);return this});
...
for(var i=this.length-1;i>=0;--i) if (x._61_(this[i])) return true;
return false});
Array.prototype.$def(function _includesAll_(aCollection){var $_self_$=this;var $_err_$={};try{$asNil$(aCollection)._do_(function(elem){if(true==$_self_$._includes_(elem))return undefined;else throw $_err_$=false});return true}catch(e){if(e===$_err_$)return e;throw e}});
...
Boolean.prototype.$def(function _identityHash(){if(true==this)return 393540864;return 1065407232});
...
Number.prototype.$def(function _raisedTo_(aNumber){if(true==$asNil$(aNumber)._isInteger())return this._raisedToInteger_(aNumber);if(true==$asNil$(aNumber)._isFraction())return this._raisedToFraction_(aNumber);if(this<0)return ArithmeticError._signal_("Negative numbers can't be raised to float powers.");if(0==aNumber)return $asNil$(this._class())._one();if(1==aNumber)return this;if(0==this)if(aNumber<0)return $asNil$(ZeroDivide._dividend_(1))._signal();else return this;return $asNil$($asNil$(aNumber)._42_(this._ln()))._exp()});
...
Point.prototype.$def(function _scaledByDisplayScaleFactor(){return this._42_($asNil$(World)._displayScaleFactor())});
...
Point.__proto__.$def(function _approvedSelectorsForMethodFinder(){return this._selectors()});
...
PjCollection.prototype.$def(function _includesAll_(aCollection){var $_self_$=this;var $_err_$={};try{$asNil$(aCollection)._do_(function(elem){if(true==$_self_$._includes_(elem))return undefined;else throw $_err_$=false});return true}catch(e){if(e===$_err_$)return e;throw e}});
...
Margin.prototype.$def(function _expandRectangle_(aRectangle){return PjRectangle._left_right_top_bottom_($asNil$($asNil$(aRectangle)._left())._45_(this._left()),$asNil$($asNil$(aRectangle)._right())._43_(this._right()),$asNil$($asNil$(aRectangle)._top())._45_(this._top()),$asNil$($asNil$(aRectangle)._bottom())._43_(this._bottom()))});
Margin.prototype.$def(function _extendRectangle_(aRectangle){return PjRectangle._origin_corner_($asNil$(aRectangle)._origin(),$asNil$($asNil$(aRectangle)._corner())._43_($asNil$(this._width())._64_(this._height())))});
...
Margin.prototype.$def(function _height(){return $asNil$(this._bottom())._43_(this._top())});
...
Margin.prototype.$def(function _insetRectangle_(aRectangle){var l,r,t,b;l=$asNil$($asNil$(aRectangle)._left())._43_(this._left());r=$asNil$(this.left)._max_($asNil$($asNil$(aRectangle)._right())._45_(this._right()));t=$asNil$($asNil$(aRectangle)._top())._43_(this._top());b=$asNil$(this.top)._max_($asNil$($asNil$(aRectangle)._bottom())._45_(this._bottom()));return PjRectangle._left_right_top_bottom_(l,r,t,b)});
...
Margin.prototype.$def(function _printOn_(aStream){var $1;Object.prototype._printOn_.call(this,aStream);{$1=$asNil$(aStream);$1._nextPutAll_(" top: ");$1._print_(this.top);$1._nextPutAll_(" left: ");$1._print_(this.left);$1._nextPutAll_(" bottom: ");$1._print_(this.bottom);$1._nextPutAll_(" right: ");$1._print_(this.right)}return this});
...
Margin.prototype.$def(function _width(){return $asNil$(this._right())._43_(this._left())});
Margin.__proto__.$def(function _approvedSelectorsForMethodFinder(){return this._selectors()});
...
Margin.__proto__.$def(function _left_right_top_bottom_(leftNumber,rightNumber,topNumber,bottomNumber){return $asNil$(this._new())._setTop_left_bottom_right_(topNumber,leftNumber,bottomNumber,rightNumber)});
...
Object._subclass_("LoEvent");
LoEvent.prototype.$def(function _dispatchToObserversFrom_(aDispatcher){$asNil$(this._class())._dispatch_toObserversFrom_(this,aDispatcher);return this});
LoEvent.__proto__.$def(function _dispatch_toObserversFrom_(anEvent,aDispatcher){$asNil$($asNil$(aDispatcher)._observersOf_(this))._do_(function(anObserver){return $asNil$(anObserver)._handle_(anEvent)});if(this===LoEvent)return this;$asNil$(this._superclass())._dispatch_toObserversFrom_(anEvent,aDispatcher);return this});
...
Array._subclass_("LjSubjectOrderedCollection");
LjSubjectOrderedCollection.prototype.$def(function _addFirst_(anObject){Array.prototype._addFirst_.call(this,anObject);this._dispatchEventAdded_at_(anObject,1);return anObject});
LjSubjectOrderedCollection.prototype.$def(function _addLast_(anObject){Array.prototype._addLast_.call(this,anObject);this._dispatchEventAdded_at_(anObject,this._size());return anObject});
LjSubjectOrderedCollection.prototype.$def(function _asSubject(){return this});
LjSubjectOrderedCollection.prototype.$def(function _at_put_(key,addedObject){var removedObject,event;if(this._dispatcher()==undefined)return Array.prototype._at_put_.call(this,key,addedObject);removedObject=this._at_ifAbsent_(key,function(){return undefined});Array.prototype._at_put_.call(this,key,addedObject);event=LoSingleElementReplaceEvent._at_replaced_by_(key,removedObject,addedObject);$asNil$(this._dispatcher())._dispatch_(event);return addedObject});
LjSubjectOrderedCollection.prototype.$def(function _dispatchEventAdded_(anObject){var event;if(this._dispatcher()==undefined)return this;event=LoSingleElementAddEvent._element_(anObject);$asNil$(this._dispatcher())._dispatch_(event);return this});
LjSubjectOrderedCollection.prototype.$def(function _dispatchEventAdded_at_(anObject,index){var event;if(this._dispatcher()==undefined)return this;event=LoSingleElementAddEvent._element_at_(anObject,index);$asNil$(this._dispatcher())._dispatch_(event);return this});
LjSubjectOrderedCollection.prototype.$def(function _dispatchEventRemoved_(anObject){var event;event=LoSingleElementRemoveEvent._element_(anObject);$asNil$(this._dispatcher())._dispatch_(event);return this});
LjSubjectOrderedCollection.prototype.$def(function _dispatchEventRemoved_at_(anObject,index){var event;event=LoSingleElementRemoveEvent._element_at_(anObject,index);$asNil$(this._dispatcher())._dispatch_(event);return this});
LjSubjectOrderedCollection.prototype.$def(function _dispatcher(){return this.dispatcher});
LjSubjectOrderedCollection.prototype.$def(function _dispatcher_(anObject){this.dispatcher=anObject;return this});
LjSubjectOrderedCollection.prototype.$def(function _removeAt_(index){var removedObject;removedObject=Array.prototype._removeAt_.call(this,index);this._dispatchEventRemoved_at_(removedObject,index);return removedObject});
LjSubjectOrderedCollection.prototype.$def(function _removeFirst(){var removedObject;removedObject=Array.prototype._removeFirst.call(this);this._dispatchEventRemoved_at_(removedObject,1);return removedObject});
LjSubjectOrderedCollection.prototype.$def(function _removeLast(){var removedObject,index;index=this._size();removedObject=Array.prototype._removeLast.call(this);this._dispatchEventRemoved_at_(removedObject,index);return removedObject});
...
PjSet.prototype.$def(function _asSubject(){LoSubjectSet._adoptInstance_(this);return this});
...
PjDictionary.prototype.$def(function _asSubject(){LoSubjectDictionary._adoptInstance_(this);return this});
...
LoEvent._subclass_("LoSingleElementChangeEvent");
LoSingleElementChangeEvent.prototype.$def(function _element(){return this.element});
LoSingleElementChangeEvent.prototype.$def(function _element_(anObject){this.element=anObject;return this});
LoSingleElementChangeEvent.prototype.$def(function _index(){return this.index});
LoSingleElementChangeEvent.prototype.$def(function _index_(anObject){this.index=anObject;return this});
LoSingleElementChangeEvent.__proto__.$def(function _element_(anObject){var $1;return ($1=$asNil$(this._new()),$1._element_(anObject),$1._yourself())});
LoSingleElementChangeEvent.__proto__.$def(function _element_at_(anObject,index){var $1;return ($1=$asNil$(this._element_(anObject)),$1._index_(index),$1._yourself())});
...
LoSingleElementChangeEvent._subclass_("LoSingleElementAddEvent");
LoSingleElementChangeEvent._subclass_("LoSingleElementRemoveEvent");
PjDictionary._subclass_("LoSubjectDictionary");
LoSubjectDictionary.prototype.$def(function _asSubject(){return this});
LoSubjectDictionary.prototype.$def(function _asSubject(){return this});
LoSubjectDictionary.prototype.$def(function _at_put_(key,addedObject){var removedObject,event;if(this._dispatcher()==undefined)return PjDictionary.prototype._at_put_.call(this,key,addedObject);removedObject=this._at_ifAbsent_(key,function(){return undefined});PjDictionary.prototype._at_put_.call(this,key,addedObject);event=LoSingleElementReplaceEvent._at_replaced_by_(key,removedObject,addedObject);$asNil$(this._dispatcher())._dispatch_(event);return addedObject});
LoSubjectDictionary.prototype.$def(function _dispatcher(){return this.dispatcher});
LoSubjectDictionary.prototype.$def(function _dispatcher(){return this.dispatcher});
LoSubjectDictionary.prototype.$def(function _dispatcher(){return this.dispatcher});
LoSubjectDictionary.prototype.$def(function _dispatcher_(anObject){this.dispatcher=anObject;return this});
LoSubjectDictionary.prototype.$def(function _dispatcher_(anObject){this.dispatcher=anObject;return this});
LoSubjectDictionary.prototype.$def(function _dispatcher_(anObject){this.dispatcher=anObject;return this});
LoSingleElementChangeEvent._subclass_("LoSingleElementReplaceEvent");
LoSingleElementReplaceEvent.prototype.$def(function _addedElement(){return this.addedElement});
LoSingleElementReplaceEvent.prototype.$def(function _addedElement_(anObject){this.addedElement=anObject;return this});
LoSingleElementReplaceEvent.prototype.$def(function _key(){return this.key});
LoSingleElementReplaceEvent.prototype.$def(function _key_(anObject){this.key=anObject;return this});
LoSingleElementReplaceEvent.prototype.$def(function _removedElement(){return this._element()});
LoSingleElementReplaceEvent.prototype.$def(function _removedElement_(anObject){return this._element_(anObject)});
LoSingleElementReplaceEvent.__proto__.$def(function _at_replaced_by_(key,oldObject,newObject){var $1;return ($1=$asNil$(this._new()),$1._key_(key),$1._removedElement_(oldObject),$1._addedElement_(newObject),$1._yourself())});
PjSet._subclass_("LoSubjectSet");
LoSubjectSet.prototype.$def(function _add_(anObject){var initialSize;initialSize=this._size();PjSet.prototype._add_.call(this,anObject);if(this._size()>initialSize)this._dispatchEventAdded_(anObject);return anObject});
LoSubjectSet.prototype.$def(function _asSubject(){return this});
LoSubjectSet.prototype.$def(function _dispatchEventAdded_(anObject){var event;if(this._dispatcher()==undefined)return this;event=LoSingleElementAddEvent._element_(anObject);$asNil$(this._dispatcher())._dispatch_(event);return this});
LoSubjectSet.prototype.$def(function _dispatchEventAdded_at_(anObject,index){var event;if(this._dispatcher()==undefined)return this;event=LoSingleElementAddEvent._element_at_(anObject,index);$asNil$(this._dispatcher())._dispatch_(event);return this});
LoSubjectSet.prototype.$def(function _dispatchEventRemoved_(anObject){var event;event=LoSingleElementRemoveEvent._element_(anObject);$asNil$(this._dispatcher())._dispatch_(event);return this});
LoSubjectSet.prototype.$def(function _dispatchEventRemoved_at_(anObject,index){var event;event=LoSingleElementRemoveEvent._element_at_(anObject,index);$asNil$(this._dispatcher())._dispatch_(event);return this});
LoSubjectSet.prototype.$def(function _dispatcher(){return this.dispatcher});
LoSubjectSet.prototype.$def(function _dispatcher(){return this.dispatcher});
LoSubjectSet.prototype.$def(function _dispatcher_(anObject){return this.dispatcher=anObject});
LoSubjectSet.prototype.$def(function _dispatcher_(anObject){return this.dispatcher=anObject});
LoSubjectSet.prototype.$def(function _remove_ifAbsent_(anObject,aBlock){var $_err_$={};try{PjSet.prototype._remove_ifAbsent_.call(this,anObject,function(){throw $_err_$=$asNil$(aBlock)._value()});this._dispatchEventRemoved_(anObject);return anObject}catch(e){if(e===$_err_$)return e;throw e}});
PjUndefinedObject._javascriptInitialize();
Error._javascriptInitialize();
Boolean._initialize();
Number._javascriptInitialize();
function LoCompositeObserver(){};
function LjDiceListController(){};
function LoDice(){};
function LoGenericObserver(){};
function LjDiceAdderApp(){};
function PjDOMApplication(){};
function LoIvChangeEvent(){};
function LoDiceAdder(){};
function LoEventDispatcher(){};
function PjFileBasedWebApp(){};
function PjApplication(){};
function LjDiceController(){};
function LjSubject(){};
function LoDiceList(){};
function PjWebsocketDelegate(){};
function PjDomController(){};
function PjWebApplication(){};
function LjDiceListApp(){};
...
for(var i=this.length-1;i>=0;--i) if (x._61_(this[i])) return true;
return false});
HTMLCollection.prototype.$def(function _includesAll_(aCollection){var $_self_$=this;var $_err_$={};try{$asNil$(aCollection)._do_(function(elem){if(true==$_self_$._includes_(elem))return undefined;else throw $_err_$=false});return true}catch(e){if(e===$_err_$)return e;throw e}});
...
for(var i=this.length-1;i>=0;--i) if (x._61_(this[i])) return true;
return false});
NodeList.prototype.$def(function _includesAll_(aCollection){var $_self_$=this;var $_err_$={};try{$asNil$(aCollection)._do_(function(elem){if(true==$_self_$._includes_(elem))return undefined;else throw $_err_$=false});return true}catch(e){if(e===$_err_$)return e;throw e}});
...
PjWebsocketDelegate.prototype.$def(function _close(){$asNil$(this.webSocket)._close();return this});
PjWebsocketDelegate.prototype.$def(function _connectTo_(urlString){this.webSocket=$asNil$(WebSocket)._new_(urlString);this._initWebSocket();return this});
PjWebsocketDelegate.prototype.$def(function _initWebSocket(){var $_self_$=this;$asNil$(this.webSocket)._instVarNamed_put_("onopen",function(event){return $_self_$._onOpen_(event)});$asNil$(this.webSocket)._instVarNamed_put_("onmessage",function(event){return $_self_$._onMessage_(event)});$asNil$(this.webSocket)._instVarNamed_put_("onclose",function(event){return $_self_$._onClose_(event)});$asNil$(this.webSocket)._instVarNamed_put_("onerror",function(event){return $_self_$._onError_(event)});return this});
PjWebsocketDelegate.prototype.$def(function _isClosed(){if(this.webSocket==undefined)return true;return $asNil$(this.webSocket)._readyState()===$asNil$(WebSocket)._CLOSED()});
PjWebsocketDelegate.prototype.$def(function _isConnected(){if(this.webSocket==undefined)return false;return $asNil$(this.webSocket)._readyState()===$asNil$(WebSocket)._OPEN()});
PjWebsocketDelegate.prototype.$def(function _onClose_(event){return this});
PjWebsocketDelegate.prototype.$def(function _onError_(event){return this});
PjWebsocketDelegate.prototype.$def(function _onMessage_(event){return this});
PjWebsocketDelegate.prototype.$def(function _onOpen_(event){return this});
PjWebsocketDelegate.__proto__.$def(function _connectToTag_(tagString){return this._connectToUrl_("ws://"+$asNil$(location)._host()+"/"+tagString)});
PjWebsocketDelegate.__proto__.$def(function _connectToUrl_(urlString){var newInstance;newInstance=this._new();$asNil$(newInstance)._connectTo_(urlString);return newInstance});
...
LoEvent._subclass_("LoIvChangeEvent");
LoIvChangeEvent.prototype.$def(function _addIv_newValue_(ivName,newValue){return $asNil$(this.ivsDict)._at_put_(ivName,newValue)});
LoIvChangeEvent.prototype.$def(function _ifChanged_do_(ivName,aBlock){var newValue,$_self_$=this;var $_err_$={};try{newValue=$asNil$(this.ivsDict)._at_ifAbsent_(ivName,function(){throw $_err_$=$_self_$});$asNil$(aBlock)._cull_(newValue);return this}catch(e){if(e===$_err_$)return e;throw e}});
LoIvChangeEvent.prototype.$def(function _initialize(){LoEvent.prototype._initialize.call(this);this.ivsDict=PjDictionary._new();return this});
LoIvChangeEvent.prototype.$def(function _newValueFor_(ivName){return $asNil$(this.ivsDict)._at_ifAbsent_(ivName,function(){return undefined})});
...
Object._subclass_("LjSubject");
LjSubject.prototype.$def(function _afterAddToCollection_do_(ivName,aBlock){this._makeSubjectIvNamed_(ivName);return this._afterCollectionAt_triggersEvent_do_(ivName,LoSingleElementAddEvent,function(event){return $asNil$(aBlock)._cull_cull_($asNil$(event)._element(),$asNil$(event)._index())})});
LjSubject.prototype.$def(function _afterChangeDo_(aBlock){return $asNil$(this._dispatcher())._on_do_(LoIvChangeEvent,function(event){return $asNil$(aBlock)._cull_(event)})});
LjSubject.prototype.$def(function _afterChangeOf_do_(ivName,aBlock){return $asNil$(this._dispatcher())._on_do_(LoIvChangeEvent,function(event){return $asNil$(event)._ifChanged_do_(ivName,aBlock)})});
LjSubject.prototype.$def(function _afterChangeOfCollection_do_(ivName,aBlock){this._makeSubjectIvNamed_(ivName);return this._afterCollectionAt_triggersEvent_do_(ivName,LoSingleElementChangeEvent,aBlock)});
LjSubject.prototype.$def(function _afterCollectionAt_triggersEvent_do_(ivName,collectionEventClass,aBlock){var $_self_$=this;return LoCompositeObserver._children_([$asNil$(this._dispatcher())._on_do_(collectionEventClass,aBlock),this._afterChangeOf_do_(ivName,function(newCollection){return $_self_$._makeSubject_(newCollection)})])});
LjSubject.prototype.$def(function _afterRemoveFromCollection_do_(ivName,aBlock){this._makeSubjectIvNamed_(ivName);return this._afterCollectionAt_triggersEvent_do_(ivName,LoSingleElementRemoveEvent,function(event){return $asNil$(aBlock)._cull_cull_($asNil$(event)._element(),$asNil$(event)._index())})});
LjSubject.prototype.$def(function _afterReplaceInCollection_do_(ivName,aBlock){this._makeSubjectIvNamed_(ivName);return this._afterCollectionAt_triggersEvent_do_(ivName,LoSingleElementReplaceEvent,function(event){return $asNil$(aBlock)._cull_cull_cull_($asNil$(event)._key(),$asNil$(event)._addedElement(),$asNil$(event)._removedElement())})});
LjSubject.prototype.$def(function _dispatch_(anEvent){$asNil$(this._dispatcher())._dispatch_(anEvent);return this});
LjSubject.prototype.$def(function _dispatcher(){if(this.dispatcher==undefined)this.dispatcher=LoEventDispatcher._new();return this.dispatcher});
LjSubject.prototype.$def(function _makeSubject_(anObject){var $1;{$1=$asNil$(anObject);$1._asSubject();$1._dispatcher_(this._dispatcher())}return this});
LjSubject.prototype.$def(function _makeSubjectIvNamed_(ivName){this._makeSubject_(this._instVarNamed_(ivName));return this});
LjSubject.prototype.$def(function _unsubscribe_(anObserver){return $asNil$(this._dispatcher())._unsubscribe_(anObserver)});
LjSubject.prototype.$def(function _when_do_(eventClass,actionBlock){return $asNil$(this._dispatcher())._on_do_(eventClass,actionBlock)});
Object._subclass_("LoEventDispatcher");
LoEventDispatcher.prototype.$def(function _dispatch_(event){$asNil$(event)._dispatchToObserversFrom_(this);return this});
LoEventDispatcher.prototype.$def(function _initialize(){Object.prototype._initialize.call(this);this.dispatchDict=PjDictionary._new();return this});
LoEventDispatcher.prototype.$def(function _observersOf_(eventClass){return $asNil$(this.dispatchDict)._at_ifAbsentPut_(eventClass,PjSet._new())});
LoEventDispatcher.prototype.$def(function _on_do_(eventClass,aBlockClosure){var eventObservers;eventObservers=this._observersOf_(eventClass);return LoGenericObserver._observersPool_actionBlock_(eventObservers,aBlockClosure)});
LoEventDispatcher.prototype.$def(function _unsubscribe_(anObserver){$asNil$(anObserver)._stopObserving();return this});
Object._subclass_("LoCompositeObserver");
LoCompositeObserver.prototype.$def(function _children(){return this.children});
LoCompositeObserver.prototype.$def(function _children_(anObject){this.children=anObject;return this});
LoCompositeObserver.prototype.$def(function _startObserving(){$asNil$(this._children())._do_(function(each){return $asNil$(each)._startObserving()});return this});
LoCompositeObserver.prototype.$def(function _stopObserving(){$asNil$(this._children())._do_(function(each){return $asNil$(each)._stopObserving()});return this});
LoCompositeObserver.__proto__.$def(function _children_(aCollection){var $1;return ($1=$asNil$(this._new()),$1._children_(aCollection),$1._yourself())});
Object._subclass_("LoGenericObserver");
LoGenericObserver.prototype.$def(function _actionBlock(){return this.actionBlock});
LoGenericObserver.prototype.$def(function _actionBlock_(anObject){this.actionBlock=anObject;return this});
LoGenericObserver.prototype.$def(function _handle_(anEvent){$asNil$(this._actionBlock())._cull_(anEvent);return this});
LoGenericObserver.prototype.$def(function _observersPool(){return this.observersPool});
LoGenericObserver.prototype.$def(function _observersPool_(aCollection){this.observersPool=aCollection;this._startObserving();return this});
LoGenericObserver.prototype.$def(function _startObserving(){$asNil$(this._observersPool())._add_(this);return this});
LoGenericObserver.prototype.$def(function _stopObserving(){$asNil$(this._observersPool())._remove_ifAbsent_(this,function(){return undefined});return this});
LoGenericObserver.__proto__.$def(function _observersPool_actionBlock_(eventObservers,aBlockClosure){var $1;return ($1=$asNil$(this._new()),$1._observersPool_(eventObservers),$1._actionBlock_(aBlockClosure),$1._yourself())});
...
LjSubject._subclass_("LoDiceList");
LoDiceList.prototype.$def(function _addDice(){this._addDice_(LoDice._new());return this});
LoDiceList.prototype.$def(function _addDice_(newDice){$asNil$(this.dice)._add_(newDice);return this});
LoDiceList.prototype.$def(function _basicSubjectMethod_dice_(arg1){this.dice=$asNil$(arg1)._asOrderedCollection();return this});
LoDiceList.prototype.$def(function _dice(){return this.dice});
LoDiceList.prototype.$def(function _dice_(arg1){var tmp1,tmp2;tmp1=this._basicSubjectMethod_dice_(arg1);if(this.dispatcher==undefined)return tmp1;tmp2=LoIvChangeEvent._new();$asNil$(tmp2)._addIv_newValue_("dice",this.dice);$asNil$(this.dispatcher)._dispatch_(tmp2);return tmp1});
LoDiceList.prototype.$def(function _diceAt_put_(index,diceToInsert){$asNil$(this._dice())._at_put_(index,diceToInsert);return this});
LoDiceList.prototype.$def(function _facesUp(){return $asNil$(this._dice())._collect_(function(each){return $asNil$(each)._faceUp()})});
LoDiceList.prototype.$def(function _initialize(){LjSubject.prototype._initialize.call(this);this._dice_(Array._new());return this});
LoDiceList.prototype.$def(function _removeDice(){var diceToRemove,$_self_$=this;var $_err_$={};try{$asNil$(this._dice())._ifEmpty_(function(){throw $_err_$=$_self_$});diceToRemove=$asNil$(this._dice())._last();this._removeDice_(diceToRemove);return this}catch(e){if(e===$_err_$)return e;throw e}});
LoDiceList.prototype.$def(function _removeDice_(diceToRemove){$asNil$(this.dice)._remove_(diceToRemove);return this});
LoDiceList.prototype.$def(function _roll(){$asNil$(this.dice)._do_(function(each){return $asNil$(each)._roll()});return this});
LoDiceList.__proto__.$def(function _with_(dice){var $1;return ($1=$asNil$(this._new()),$1._dice_(dice),$1._yourself())});
LoDiceList.__proto__.$def(function _withDiceCount_(count){var dice;dice=$asNil$((1)._to_(count))._collect_(function(each){return LoDice._new()});return this._with_($asNil$(dice)._asOrderedCollection())});
LoDiceList.__proto__.$def(function _withTwoDice(){return this._withDiceCount_(2)});
PjDomController._subclass_("LjDiceListController");
LjDiceListController.prototype.$def(function _addControllerForDice_(aDice){var diceView,controller;diceView=this._createElement_("span");$asNil$($asNil$(diceView)._classList())._add_("diceFace");controller=LjDiceController._new();$asNil$(controller)._dice_faceUpDisplay_(aDice,diceView);$asNil$(this.diceControllers)._addLast_(controller);$asNil$(this.diceListDisplay)._appendChild_(diceView);return this});
LjDiceListController.prototype.$def(function _diceList_diceListDisplay_(aDiceList,htmlElement){var $_self_$=this;this.diceControllers=Array._new();this.diceList=aDiceList;this.diceListDisplay=htmlElement;$asNil$($asNil$(aDiceList)._dice())._do_(function(aDice){return $_self_$._addControllerForDice_(aDice)});$asNil$(aDiceList)._afterAddToCollection_do_("dice",function(newDice){return $_self_$._addControllerForDice_(newDice)});$asNil$(aDiceList)._afterRemoveFromCollection_do_("dice",function(oldDice,oldDiceIndex){return $_self_$._removeDiceControllerAt_(oldDiceIndex)});return this});
LjDiceListController.prototype.$def(function _removeDiceControllerAt_(index){var diceView,controller;controller=$asNil$(this.diceControllers)._at_(index);diceView=$asNil$(controller)._faceUpDisplay();$asNil$(this.diceListDisplay)._removeChild_(diceView);$asNil$(this.diceControllers)._remove_(controller);return this});
LjSubject._subclass_("LoDice");
LoDice.prototype.$def(function _basicSubjectMethod_faceUp_(arg1){return this.faceUp=arg1});
LoDice.prototype.$def(function _basicSubjectMethod_faces_(arg1){this.faces=arg1;this._roll();return this});
LoDice.prototype.$def(function _defaultFacesCount(){return 6});
LoDice.prototype.$def(function _faceUp(){return this.faceUp});
LoDice.prototype.$def(function _faceUp_(arg1){var tmp1,tmp2;tmp1=this._basicSubjectMethod_faceUp_(arg1);if(this.dispatcher==undefined)return tmp1;tmp2=LoIvChangeEvent._new();$asNil$(tmp2)._addIv_newValue_("faceUp",this.faceUp);$asNil$(this.dispatcher)._dispatch_(tmp2);return tmp1});
LoDice.prototype.$def(function _faces(){return this.faces});
LoDice.prototype.$def(function _faces_(arg1){var tmp1,tmp2;tmp1=this._basicSubjectMethod_faces_(arg1);if(this.dispatcher==undefined)return tmp1;tmp2=LoIvChangeEvent._new();$asNil$(tmp2)._addIv_newValue_("faces",this.faces);$asNil$(this.dispatcher)._dispatch_(tmp2);return tmp1});
LoDice.prototype.$def(function _facesCount(){return $asNil$(this._faces())._size()});
LoDice.prototype.$def(function _facesCount_(faceMaxValue){this._faces_((1)._to_(faceMaxValue));return this});
LoDice.prototype.$def(function _initialize(){LjSubject.prototype._initialize.call(this);this._facesCount_(this._defaultFacesCount());return this});
LoDice.prototype.$def(function _roll(){return this._faceUp_($asNil$(this._faces())._atRandom())});
LoDice.__proto__.$def(function _faces_(faces){var $1;return ($1=$asNil$(this._new()),$1._faces_(faces),$1._yourself())});
LoDice.__proto__.$def(function _of_(facesCount){return this._faces_((1)._to_(facesCount))});
PjDomController._subclass_("LjDiceController");
LjDiceController.prototype.$def(function _dice(){return this.dice});
LjDiceController.prototype.$def(function _dice_faceUpDisplay_(aDice,htmlElement){var $_self_$=this;this.dice=aDice;this.faceUpDisplay=htmlElement;$asNil$(this.faceUpDisplay)._addEventListener_block_("click",function(){return $asNil$($_self_$.dice)._roll()});$asNil$(this.dice)._afterChangeOf_do_("faceUp",function(newFaceUp){return $_self_$._diceFaceUp_(newFaceUp)});this._diceFaceUp_($asNil$(this.dice)._faceUp());return this});
LjDiceController.prototype.$def(function _diceFaceChangedCssClass(){return "diceFaceChanged"});
LjDiceController.prototype.$def(function _diceFaceUp_(newFaceUp){var $_self_$=this;$asNil$($asNil$(this.faceUpDisplay)._classList())._add_(this._diceFaceChangedCssClass());$asNil$(this.faceUpDisplay)._textContent_(newFaceUp);this._setTimeout_afterMilliseconds_(function(){return $asNil$($asNil$($_self_$.faceUpDisplay)._classList())._remove_($_self_$._diceFaceChangedCssClass())},100);return this});
LjDiceController.prototype.$def(function _faceUpDisplay(){return this.faceUpDisplay});
...
LoDiceList._subclass_("LoDiceAdder");
LoDiceAdder.prototype.$def(function _basicSubjectMethod_total_(arg1){this.total=arg1;return this});
LoDiceAdder.prototype.$def(function _dice_(aCollection){var $_self_$=this;LoDiceList.prototype._dice_.call(this,aCollection);$asNil$(this._dice())._do_(function(each){return $_self_$._linkTo_(each)});return this});
LoDiceAdder.prototype.$def(function _initialize(){var $_self_$=this;LoDiceList.prototype._initialize.call(this);this._afterChangeOfCollection_do_("dice",function(){return $_self_$._updateTotal()});this._afterReplaceInCollection_do_("dice",function(index,newDice){return $_self_$._linkTo_(newDice)});this._afterAddToCollection_do_("dice",function(newDice){return $_self_$._linkTo_(newDice)});this._afterChangeOf_do_("dice",function(){return $_self_$._updateTotal()});this._updateTotal();return this});
LoDiceAdder.prototype.$def(function _linkTo_(aDice){var $_self_$=this;$asNil$(aDice)._afterChangeOf_do_("faceUp",function(){return $_self_$._updateTotal()});return this});
LoDiceAdder.prototype.$def(function _total(){return this.total});
LoDiceAdder.prototype.$def(function _total_(arg1){var tmp1,tmp2;tmp1=this._basicSubjectMethod_total_(arg1);if(this.dispatcher==undefined)return tmp1;tmp2=LoIvChangeEvent._new();$asNil$(tmp2)._addIv_newValue_("total",this.total);$asNil$(this.dispatcher)._dispatch_(tmp2);return tmp1});
LoDiceAdder.prototype.$def(function _updateTotal(){var newTotal;newTotal=$asNil$(this._dice())._inject_into_(0,function(sum,each){return $asNil$(sum)._43_($asNil$(each)._faceUp())});return this._total_(newTotal)});
PjWebApplication._subclass_("PjFileBasedWebApp");
PjFileBasedWebApp._subclass_("LjDiceListApp");
LjDiceListApp.prototype.$def(function _diceList(){return this.diceList});
LjDiceListApp.prototype.$def(function _diceListClass(){return LoDiceList});
LjDiceListApp.prototype.$def(function _initialize(){var $_self_$=this;PjFileBasedWebApp.prototype._initialize.call(this);this.diceList=$asNil$(this._diceListClass())._withDiceCount_(3);this.diceListDisplay=this._elementAt_("diceListView");this.diceListController=LjDiceListController._new();$asNil$(this.diceListController)._diceList_diceListDisplay_(this.diceList,this.diceListDisplay);$asNil$(this._elementAt_("addDiceButton"))._addEventListener_block_("click",function(){return $asNil$($_self_$.diceList)._addDice()});$asNil$(this._elementAt_("removeDiceButton"))._addEventListener_block_("click",function(){return $_self_$._removeDice()});$asNil$(this._elementAt_("rollDiceButton"))._addEventListener_block_("click",function(){return $asNil$($_self_$.diceList)._roll()});return this});
LjDiceListApp.prototype.$def(function _removeDice(){if(2>$asNil$($asNil$(this.diceList)._dice())._size())return this;$asNil$(this.diceList)._removeDice();return this});
LjDiceListApp.prototype.$def(function _view(){return this.diceListDisplay});
LjDiceListApp.__proto__.$def(function _appJsSubFolder(){return "js"});
LjDiceListApp._subclass_("LjDiceAdderApp");
LjDiceAdderApp.prototype.$def(function _diceListClass(){return LoDiceAdder});
LjDiceAdderApp.prototype.$def(function _initialize(){var totalView;LjDiceListApp.prototype._initialize.call(this);totalView=this._elementAt_("diceTotalView");$asNil$(this.diceList)._afterChangeOf_do_("total",function(newTotal){return $asNil$(totalView)._textContent_(newTotal)});$asNil$(totalView)._textContent_($asNil$(this.diceList)._total());return this});
Smalltalk._registerDnuForAll_(["%","*","+",",","-","/","//","=","@","CLOSED","OPEN","\\\\","abs","actionBlock","actionBlock:","adaptToPoint:andSend:","add:","addAll:","addAllLast:","addControllerForDice:","addDice","addDice:","addElement:to:","addElement:to:style:","addEventListener:block:","addFirst:","addIv:newValue:","addLast:","addedElement","addedElement:","adhereTo:","adoptInstance:","afterAddToCollection:do:","afterChangeOf:do:","afterChangeOfCollection:do:","afterCollectionAt:triggersEvent:do:","afterRemoveFromCollection:do:","afterReplaceInCollection:do:","allButFirst:","allButLast:","allEnumeratableKeysDo:","allSubclassesDo:","angle","appendChild:","appendTo:","apply:with:","arcTan","arcTan:","arguments","as:","asCharacter","asDictionary","asFloat","asInteger","asJsObject","asOrderedCollection","asPoint","asString","asSubject","asUppercase","asciiValue","associationsDo:","at:","at:ifAbsent:","at:ifAbsentPut:","at:ifPresent:","at:put:","at:replaced:by:","atRandom","attribute:at:set:","attribute:ofElement:","attribute:ofElement:set:","basicAt:","basicNew","basicNew:","basicNew:with:","basicNew:with:with:","basicNew:with:with:with:","basicNew:with:with:with:with:","basicSubjectMethod_dice:","basicSubjectMethod_faceUp:","basicSubjectMethod_faces:","basicSubjectMethod_total:","beginsWith:","bitAnd:","bitShift:","body","bottom","call:","call:with:","call:with:with:","call:with:with:with:","canUnderstand:","capitalized","ceiling","children","children:","class","classList","className","classSubclassResponsibilitySet","close","closeTo:","collect:","connectTo:","connectToUrl:","containsPoint:","copyFrom:to:","corner","cos","createElement:","createElement:style:","crossProduct:","cssClassesElement:","cssClassesElement:set:","cssClassesReplaceAll:byAll:element:","cssClassesStringElement:","cssClassesStringElement:set:","cull:","cull:cull:","cull:cull:cull:","currentInstance","deepCopy","defaultFacesCount","degreesToRadians","denormalized","detect:ifFound:ifNone:","dice","dice:","dice:faceUpDisplay:","diceFaceChangedCssClass","diceFaceUp:","diceList:diceListDisplay:","diceListClass","dispatch:","dispatch:toObserversFrom:","dispatchEventAdded:","dispatchEventAdded:at:","dispatchEventRemoved:","dispatchEventRemoved:at:","dispatchToObserversFrom:","dispatcher","dispatcher:","display:","displayScaleFactor","distanceTo:","dividend:","do:","do:separatedBy:","document","dotProduct:","element","element:","element:at:","elementAt:","elementAt:in:","emptyJavascriptObject","ensure:","eqv:","error:","errorNotFound:","even","exp","faceUp","faceUp:","faceUpDisplay","faces","faces:","facesCount:","findDelimiters:startingAt:","findIndex:","first","floor","floor:","fminDenormalized","fminNormalized","fractionPart","fromNumber:","fromPoint:","fromRectangle:","getAttribute:","getElementById:","handle:","handleDNU:for:","hash","hashMultiply","height","hide:","highBit","highBitOfPositiveReceiver","host","identityHash","ifChanged:do:","ifEmpty:","ifTrue:ifFalse:","includes:","includesKey:","index","index:","inheritsFrom:","initNilInJs","initObject","initThrowInJs","initWebSocket","initialize","inject:into:","innerHTML","innerHTML:","inputWidgetForPoint","instVarNamed:","instVarNamed:put:","instVarNamed:putHidden:","installDnuArgs:selector:js:for:else:","integerPart","isCharacter","isEmpty","isFloat","isFloatPoint","isFraction","isFunction:","isInteger","isIntegerPoint","isKindOf:","isLetter","isNil","isNotEmpty","isNotNil","isPoint","isVowel","isZero","js_apply:args:","js_charAt:","js_charCodeAt:","js_defineProperty:field:properties:","js_forEach:","js_fromCharCode:","js_hasOwnProperty:","js_join:","js_log:","js_parse:","js_pop","js_push:","js_shift","js_split:","js_substring:","js_substring:to:","js_toLowerCase","js_toString","js_toUpperCase","key","key:","key:value:","keysAndValuesDo:","keysDo:","last","left","left:right:top:bottom:","leftRotated","letterCharCodes","linkTo:","ln","log:","makeDNU:","makeGetter:","makeJavascriptSelector:","makeSetter:","makeSubclass","makeSubject:","makeSubjectIvNamed:","max:","messageClass:","messageText:","metaclassClass:","metaclassOf:","methods","min:","name","nearestPointAlongLineFrom:to:","negated","negative","new","new:","newFrom:","nextIdentityHash","nextPut:","nextPutAll:","nilIfUndefined","nilInJs:","nilTestFunctionName","not","notEmpty","notNil","observersOf:","observersPool","observersPool:","observersPool:actionBlock:","ofSize:","on:do:","onChange:in:do:","onChangeElement:do:","onClick:in:do:","onClickElement:do:","onClose:","onError:","onKeyUp:in:do:","onKeyUpElement:do:","onLineFrom:to:within:","onMessage:","onOpen:","one","origin","origin:corner:","origin:extent:","parseListDo:","perform:with:","pi","point:point:","postCopy","precision","print:","printOn:","printString","propertySet:","prototype","quadrantOf:","querySelector:","quo:","r","radiansToDegrees","raisedToFraction:","raisedToInteger:","readyState","reciprocal","rectangle:","registerDnu:","remove:","remove:ifAbsent:","removeAll","removeAt:","removeChild:","removeDice","removeDice:","removeDiceControllerAt:","removeFirst","removeLast","removedElement","removedElement:","replaceFrom:to:with:","replaceFrom:to:with:startingAt:","right","rightRotated","roll","roundDownTo:","roundTo:","roundUpTo:","rounded","select:","selector","selectors","sendsSelector:","setAttribute:to:","setElement:style:","setPoint:point:","setR:degrees:","setTimeout:afterMilliseconds:","setTop:left:bottom:right:","setX:setY:","shallowCopy","show:","show:element:","show:elementAt:in:","sideOf:","sign","signal","signal:","sin","size","skipDelimiters:startingAt:","space","species","split:","sqrt","start","startInstance","startObserving","stop","stopObserving","stringHash:initialHash:","stringify:","style","subclassResponsibility","subclassResponsibilitySet","subclasses","subclassesDo:","subscribeToDeviceEvents","superclass","textContent:","theta","throwFunction","throwFunctionName","timesTwoPower:","to:","to:by:do:","to:do:","to:sideOf:","top","topLeft","total","total:","triangleArea:with:","truncateTo:","truncated","typeof","unsubscribe:","updateTotal","value","value:","value:value:","value:value:value:","value:value:value:value:","valuesDo:","visitPoint:","whenJsReady:","whileFalse:","whileTrue:","width","with:","with:with:with:with:","withAll:","withDiceCount:","withIndexDo:","writeObject:streamShortList:","x","x:y:","y","yourself"]);
...
PjEvaluatorWebsocketDelegate.prototype.$def(function _close(){this.shouldRetryToConnectToServer=false;PjWebsocketDelegate.prototype._close.call(this);return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _command_(aString){var top = (function(){return this})(),
...
PjEvaluatorWebsocketDelegate.prototype.$def(function _connectTo_(urlString){this.shouldRetryToConnectToServer=true;this.bridgeUrlString=urlString;PjWebsocketDelegate.prototype._connectTo_.call(this,urlString);return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _doCallBack_(aResult){$asNil$(this.webSocket)._send_(aResult);this._logSent_(aResult);return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _eval_(aString){var result;
try{
...
PjEvaluatorWebsocketDelegate.prototype.$def(function _initialize(){PjWebsocketDelegate.prototype._initialize.call(this);$asNil$(Object._prototype())._instVarNamed_putHidden_("_inspect",this._makeInspect());return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _logReceived_(aString){$asNil$(console)._log_("Received: "+aString);return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _logSent_(aString){$asNil$(console)._log_("Sent: "+aString);return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _makeBlockClosureProxy_(withThis){return this._makeBlockClosureProxy_stopPropagation_(withThis,true)});
PjEvaluatorWebsocketDelegate.prototype.$def(function _makeBlockClosureProxy_stopPropagation_(withThis,stop){var self=this;
...
PjEvaluatorWebsocketDelegate.prototype.$def(function _makeInspect(){var wsd=this;
return function(){
wsd._doCallBack_(JSON.stringify({inspect:Object._resultObject_(this)}));
return this
}});
PjEvaluatorWebsocketDelegate.prototype.$def(function _onClose_(event){this._reconnect();return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _onError_(event){this._reconnect();return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _onMessage_(event){var aString,$_self_$=this;aString=$asNil$(event)._data();this._logReceived_(aString);if($asNil$(aString)._first()==":")return this._command_(aString);this._timeout_for_(function(){aString=$_self_$._eval_(aString);if(false==$_self_$._isClosed())$asNil$($_self_$.webSocket)._send_(aString);return $_self_$._logSent_(aString)},0);return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _reconnect(){if(false==this.shouldRetryToConnectToServer)return this;PjWebsocketDelegate.prototype._connectTo_.call(this,this.bridgeUrlString);return this});
PjEvaluatorWebsocketDelegate.prototype.$def(function _timeout_for_(aBlock,milliseconds){setTimeout(aBlock,milliseconds)});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _closeDefault(){$asNil$(this._default())._close();return this});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _connectDefaultToTag_(tagString){var newInstance;newInstance=this._connectToTag_(tagString);this._default_(newInstance);return this});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _connectDefaultToUrl_(urlString){var newInstance;newInstance=this._connectToUrl_(urlString);this._default_(newInstance);return this});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _default(){return this.default});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _default_(newInstance){this.default=newInstance;return this});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _initialize(){"JSON Math WebSocket console global document history location navigator screen window localStorage module process require".split(" ").forEach(function(s){
if(this[s]){
try{Object.defineProperty(this[s],"$_jsName",{value:s,writable:true})}catch(s){};
}})});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _reload(){this._closeDefault();$asNil$(location)._reload_(true);return this});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _reload_(aBoolean){this._closeDefault();$asNil$(location)._reload_(aBoolean);return this});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _set_callback_to_(anObject,aString,callback){aString="on"+aString;
console.log(aString);
...
return true;});
PjEvaluatorWebsocketDelegate.__proto__.$def(function _terminate(){var $_self_$=this;(function(){return $_self_$._closeDefault()})._on_do_(Error,function(){return undefined});(function(){return $asNil$(process)._exit()})._on_do_(Error,function(){return undefined});return this});
Smalltalk._registerDnuForAll_(["closeDefault","command:","connectDefaultToUrl:","connectToTag:","data","default","default:","eval:","exit","isClosed","logReceived:","logSent:","makeBlockClosureProxy:stopPropagation:","makeInspect","reconnect","reload:","send:","timeout:for:"]);
PjEvaluatorWebsocketDelegate._initialize();
(function(appClass,webSocketDelegateClass,url){return function(){$asNil$(appClass)._start();return $asNil$(webSocketDelegateClass)._connectDefaultToUrl_(url)}})(LjDiceAdderApp,PjEvaluatorWebsocketDelegate,"ws://localhost:1246/javascript-bridge")();
