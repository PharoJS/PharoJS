// generated by PharoJS *** DO NOT EDIT *** on 2019-07-18T09:41:32.033547+02:00 by noury
...
LjDiceListController.prototype.$def(function _removeDiceControllerAt_(index){var diceView,controller;controller=$asNil$(this.diceControllers)._at_(index);diceView=$asNil$(controller)._view();$asNil$(this.diceListDisplay)._removeChild_(diceView);$asNil$(this.diceControllers)._remove_(controller);return this});
...
LjDiceController.prototype.$def(function _diceFaceUp_(newFaceUp){var $_self_$=this;$asNil$($asNil$(this.faceUpDisplay)._classList())._add_(this._diceFaceChangedCssClass());$asNil$(this.faceUpDisplay)._innerHTML_(newFaceUp);this._setTimeout_afterMilliseconds_(function(){return $asNil$($asNil$($_self_$.faceUpDisplay)._classList())._remove_($_self_$._diceFaceChangedCssClass())},100);return this});
...
LjDiceListApp.prototype.$def(function _initialize(){var $_self_$=this;PjFileBasedWebApp.prototype._initialize.call(this);this.model=LoDiceList._withDiceCount_(3);this.view=this._elementAt_("diceListView");this.controller=LjDiceListController._new();$asNil$(this.controller)._diceList_diceListDisplay_(this.model,this.view);$asNil$(this._elementAt_("addDiceButton"))._addEventListener_block_("click",function(){return $asNil$($_self_$.model)._addDice()});$asNil$(this._elementAt_("removeDiceButton"))._addEventListener_block_("click",function(){return $asNil$($_self_$.model)._removeDice()});return this});
LjDiceListApp.prototype.$def(function _model(){return this.model});
LjDiceListApp.prototype.$def(function _view(){return this.view});
LjDiceListApp.__proto__.$def(function _appJsSubFolder(){return "js"});
Smalltalk._registerDnuForAll_(["%","*","+",",","-","/","//","=","@","\\\\","abs","actionBlock","actionBlock:","adaptToPoint:andSend:","add:","addAll:","addAllLast:","addControllerForDice:","addDice","addDice:","addElement:to:","addElement:to:style:","addEventListener:block:","addFirst:","addIv:newValue:","addLast:","addedElement","addedElement:","adhereTo:","adoptInstance:","afterAddToCollection:do:","afterChangeOf:do:","afterCollectionAt:triggersEvent:do:","afterRemoveFromCollection:do:","allButFirst:","allButLast:","allEnumeratableKeysDo:","allSubclassesDo:","angle","appendChild:","appendTo:","apply:with:","arcTan","arcTan:","arguments","as:","asCharacter","asDictionary","asFloat","asInteger","asJsObject","asOrderedCollection","asPoint","asString","asSubject","asUppercase","asciiValue","associationsDo:","at:","at:ifAbsent:","at:ifAbsentPut:","at:ifPresent:","at:put:","at:replaced:by:","atRandom","attribute:at:set:","attribute:ofElement:","attribute:ofElement:set:","basicAt:","basicNew","basicNew:","basicNew:with:","basicNew:with:with:","basicNew:with:with:with:","basicNew:with:with:with:with:","basicSubjectMethod_dice:","basicSubjectMethod_faceUp:","basicSubjectMethod_faces:","beginsWith:","bitAnd:","bitShift:","body","bottom","call:","call:with:","call:with:with:","call:with:with:with:","canUnderstand:","capitalized","ceiling","children","children:","class","classList","className","classSubclassResponsibilitySet","closeTo:","collect:","containsPoint:","copyFrom:to:","corner","cos","createElement:","createElement:style:","crossProduct:","cssClassesElement:","cssClassesElement:set:","cssClassesReplaceAll:byAll:element:","cssClassesStringElement:","cssClassesStringElement:set:","cull:","cull:cull:","cull:cull:cull:","currentInstance","deepCopy","defaultFacesCount","degreesToRadians","denormalized","detect:ifFound:ifNone:","dice","dice:","dice:faceUpDisplay:","diceFaceChangedCssClass","diceFaceUp:","diceList:diceListDisplay:","dispatch:","dispatch:toObserversFrom:","dispatchEventAdded:","dispatchEventAdded:at:","dispatchEventRemoved:","dispatchEventRemoved:at:","dispatchToObserversFrom:","dispatcher","dispatcher:","display:","displayScaleFactor","distanceTo:","dividend:","do:","do:separatedBy:","document","dotProduct:","element","element:","element:at:","elementAt:","elementAt:in:","emptyJavascriptObject","ensure:","eqv:","error:","errorNotFound:","even","exp","faceUp","faceUp:","faces","faces:","facesCount:","findDelimiters:startingAt:","findIndex:","first","floor","floor:","fminDenormalized","fminNormalized","fractionPart","fromNumber:","fromPoint:","fromRectangle:","getAttribute:","getElementById:","handle:","handleDNU:for:","hash","hashMultiply","height","hide:","highBit","highBitOfPositiveReceiver","identityHash","ifChanged:do:","ifEmpty:","ifTrue:ifFalse:","includes:","includesKey:","index","index:","inheritsFrom:","initNilInJs","initObject","initThrowInJs","initialize","innerHTML","innerHTML:","inputWidgetForPoint","instVarNamed:","instVarNamed:put:","instVarNamed:putHidden:","installDnuArgs:selector:js:for:else:","integerPart","isCharacter","isEmpty","isFloat","isFloatPoint","isFraction","isFunction:","isInteger","isIntegerPoint","isKindOf:","isLetter","isNil","isNotEmpty","isNotNil","isPoint","isVowel","isZero","js_apply:args:","js_charAt:","js_charCodeAt:","js_defineProperty:field:properties:","js_forEach:","js_fromCharCode:","js_hasOwnProperty:","js_join:","js_log:","js_parse:","js_pop","js_push:","js_shift","js_split:","js_substring:","js_substring:to:","js_toLowerCase","js_toString","js_toUpperCase","key","key:","key:value:","keysAndValuesDo:","keysDo:","last","left","left:right:top:bottom:","leftRotated","letterCharCodes","ln","log:","makeDNU:","makeGetter:","makeJavascriptSelector:","makeSetter:","makeSubclass","makeSubject:","makeSubjectIvNamed:","max:","messageClass:","messageText:","metaclassClass:","metaclassOf:","methods","min:","name","nearestPointAlongLineFrom:to:","negated","negative","new","new:","newFrom:","nextIdentityHash","nextPut:","nextPutAll:","nilIfUndefined","nilInJs:","nilTestFunctionName","not","notEmpty","notNil","observersOf:","observersPool","observersPool:","observersPool:actionBlock:","ofSize:","on:do:","onChange:in:do:","onChangeElement:do:","onClick:in:do:","onClickElement:do:","onKeyUp:in:do:","onKeyUpElement:do:","onLineFrom:to:within:","one","origin","origin:corner:","origin:extent:","parseListDo:","perform:with:","pi","point:point:","postCopy","precision","print:","printOn:","printString","propertySet:","prototype","quadrantOf:","querySelector:","quo:","r","radiansToDegrees","raisedToFraction:","raisedToInteger:","reciprocal","rectangle:","registerDnu:","remove:","remove:ifAbsent:","removeAll","removeAt:","removeChild:","removeDice","removeDice:","removeDiceControllerAt:","removeFirst","removeLast","removedElement","removedElement:","replaceFrom:to:with:","replaceFrom:to:with:startingAt:","right","rightRotated","roll","roundDownTo:","roundTo:","roundUpTo:","rounded","select:","selector","selectors","sendsSelector:","setAttribute:to:","setElement:style:","setPoint:point:","setR:degrees:","setTimeout:afterMilliseconds:","setTop:left:bottom:right:","setX:setY:","shallowCopy","show:","show:element:","show:elementAt:in:","sideOf:","sign","signal","signal:","sin","size","skipDelimiters:startingAt:","space","species","split:","sqrt","start","startInstance","startObserving","stop","stopObserving","stringHash:initialHash:","stringify:","style","subclassResponsibility","subclassResponsibilitySet","subclasses","subclassesDo:","subscribeToDeviceEvents","superclass","theta","throwFunction","throwFunctionName","timesTwoPower:","to:","to:by:do:","to:do:","to:sideOf:","top","topLeft","triangleArea:with:","truncateTo:","truncated","typeof","unsubscribe:","value","value:","value:value:","value:value:value:","value:value:value:value:","valuesDo:","view","visitPoint:","whenJsReady:","whileFalse:","whileTrue:","width","with:","with:with:with:with:","withAll:","withDiceCount:","withIndexDo:","writeObject:streamShortList:","x","x:y:","y","yourself"]);
(function(appClass){return function(){return $asNil$(appClass)._start()}})(LjDiceListApp)();
