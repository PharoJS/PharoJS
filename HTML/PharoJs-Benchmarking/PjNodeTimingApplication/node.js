#! /usr/bin/env node
// generated by PharoJS *** DO NOT EDIT *** on 2023-03-21T21:15:00.633903+01:00 by noury
'use strict';
...
PjApplication.pj_subclass_("PjNodeApplication");
PjNodeApplication.$$def(function(i$,c$,cp$){
c$(function pj_isAbstract(){if(this==PjNodeApplication){return true}else{return PjApplication.pj_isAbstract.call(this)}});
c$(function pj_whenJsReady_(aBlock){$asNil$(aBlock).pj_value();return this});
});
