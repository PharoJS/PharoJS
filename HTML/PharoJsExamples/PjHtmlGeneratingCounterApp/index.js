// generated by PharoJS *** DO NOT EDIT *** on 2018-06-19T16:01:01.504119+02:00 by noury
...
Smalltalk._registerDnuForAll_(["%","*","+",",","-","/","//","=","@","CLOSED","OPEN","\\\\","abs","adaptToPoint:andSend:","add:","addAll:","addAllLast:","addFirst:","addLast:","adhereTo:","adoptInstance:","allButFirst:","allButLast:","allEnumeratableKeysDo:","allSubclassesDo:","angle","appendTo:","apply:with:","arcTan","arcTan:","arguments","as:","asCharacter","asFloat","asInteger","asPoint","asString","asUppercase","asciiValue","associationsDo:","at:","at:ifAbsent:","at:ifAbsentPut:","at:ifPresent:","at:put:","basicAt:","basicNew","basicNew:","basicNew:with:","basicNew:with:with:","basicNew:with:with:with:","basicNew:with:with:with:with:","beginsWith:","bitAnd:","bitShift:","bottom","call:","call:with:","call:with:with:","call:with:with:with:","canUnderstand:","capitalized","ceiling","class","className","close","closeTo:","collect:","connectTo:","connectToUrl:","containsPoint:","copyFrom:to:","corner","cos","crossProduct:","cull:","deepCopy","degreesToRadians","denominator","denormalized","detect:ifFound:ifNone:","dist:","dividend:","do:","do:separatedBy:","dotProduct:","emptyJavascriptObject","ensure:","eqv:","error:","errorNotFound:","even","exp","findDelimiters:startingAt:","findIndex:","first","floor","floor:","fminDenormalized","fminNormalized","fractionPart","fromNumber:","fromPoint:","fromRectangle:","getElementById:","handleDNU:for:","hash","hashMultiply","height","highBit","highBitOfPositiveReceiver","host","identityHash","ifTrue:ifFalse:","includes:","includesKey:","inheritsFrom:","initNilInJs","initObject","initThrowInJs","initWebSocket","initialize","inputWidgetForPoint","instVarNamed:","instVarNamed:put:","instVarNamed:putHidden:","installDnuArgs:selector:js:for:else:","integerPart","isCharacter","isEmpty","isFloat","isFloatPoint","isFraction","isFunction:","isInteger","isIntegerPoint","isLetter","isNil","isNotNil","isPoint","isVowel","isZero","js_apply:args:","js_charAt:","js_charCodeAt:","js_defineProperty:field:properties:","js_forEach:","js_fromCharCode:","js_hasOwnProperty:","js_join:","js_log:","js_parse:","js_pop","js_push:","js_shift","js_split:","js_substring:","js_substring:to:","js_toLowerCase","js_toString","js_toUpperCase","key","key:","key:value:","keysAndValuesDo:","keysDo:","left","leftRotated","ln","log:","makeDNU:","makeGetter:","makeJavascriptSelector:","makeSetter:","makeSubclass","max:","messageClass:","messageText:","metaclassClass:","metaclassOf:","min:","name","nearestPointAlongLineFrom:to:","negated","negative","new","new:","newFrom:","nextIdentityHash","nextPut:","nextPutAll:","nilIfUndefined","nilInJs:","nilTestFunctionName","not","notNil","nthRoot:","numerator","ofSize:","onClose:","onError:","onLineFrom:to:within:","onMessage:","onOpen:","one","origin","origin:corner:","origin:extent:","parseListDo:","perform:with:","pi","point:point:","postCopy","precision","printOn:","printString","propertySet:","prototype","quadrantOf:","querySelector:","quo:","r","radiansToDegrees","raisedToInteger:","readyState","reciprocal","rectangle:","registerDnu:","remove:","remove:ifAbsent:","removeAll","removeAt:","removeFirst","replaceFrom:to:with:","replaceFrom:to:with:startingAt:","right","rightBottom","rightRotated","roundDownTo:","roundTo:","roundUpTo:","rounded","selector","setPoint:point:","setR:degrees:","setTop:left:bottom:right:","setX:setY:","shallowCopy","sideOf:","sign","signal","signal:","sin","size","skipDelimiters:startingAt:","space","species","sqrt","stringHash:initialHash:","stringify:","subclassResponsibility","subclasses","subclassesDo:","superclass","theta","throwFunction","throwFunctionName","timesTwoPower:","to:","to:by:do:","to:do:","to:sideOf:","top","topLeft","triangleArea:with:","truncateTo:","truncated","typeof","value","value:","value:value:","value:value:value:","value:value:value:value:","valuesDo:","visitPoint:","whileFalse:","whileTrue:","width","with:","with:with:with:with:","withAll:","withIndexDo:","writeObject:streamShortList:","x","x:y:","y","yourself"]);
var process=process||{exit:function(){window.close()}};
function PjAppWrapperForRunningInPharo(){};
function PjEvaluatorWebsocketDelegate(){};
Object._subclass_("PjAppWrapperForRunningInPharo");
PjAppWrapperForRunningInPharo.__proto__.$def(function _start(){return this});
PjAppWrapperForRunningInPharo.__proto__.$def(function _stop(){return this});
...
Smalltalk._registerDnuForAll_(["closeDefault","command:","connectDefaultToUrl:","connectToTag:","data","default","default:","eval:","exit","isClosed","logReceived:","logSent:","makeBlockClosureProxy:stopPropagation:","makeInspect","on:do:","reconnect","reload:","send:","start","timeout:for:"]);
PjEvaluatorWebsocketDelegate._initialize();
(function(appClass,webSocketDelegateClass,url){return function(){$asNil$(appClass)._start();return $asNil$(webSocketDelegateClass)._connectDefaultToUrl_(url)}})(PjAppWrapperForRunningInPharo,PjEvaluatorWebsocketDelegate,"ws://localhost:1219/javascript-bridge")();
