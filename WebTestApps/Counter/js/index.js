// generated by PharoJS *** DO NOT EDIT *** on 2016-12-05T12:33:30.070064+01:00
...
PjCounterController.prototype._counter_ = function(anObject){this.counter=anObject;return this}
PjCounterController.prototype._counter = function(){return this.counter}
PjCounterController.prototype._updateDisplayBlock_ = function(anObject){this.updateDisplayBlock=anObject;return this}
PjCounterController.prototype._reset = function(){$asNil$(this._counter())._reset();this._updateDisplay();return this}
PjCounterController.prototype._updateDisplay = function(){$asNil$(this._updateDisplayBlock())._value_($asNil$(this._counter())._count());return this}
PjCounterController.prototype._updateDisplayBlock = function(){return this.updateDisplayBlock}
PjCounterController.prototype._increment = function(){$asNil$(this._counter())._increment();this._updateDisplay();return this}
...
PjCounter.prototype._initialize = function(){Object.prototype._initialize.call(this);this._reset();return this}
PjCounter.prototype._count = function(){return this.count}
PjCounter.prototype._reset = function(){this._count_(0);return this}
PjCounter.prototype._count_ = function(anObject){this.count=anObject;return this}
PjCounter.prototype._increment = function(){this._count_(this._count()+1);return this}
PjFileBasedBrowserApp._subclass_(PjCounterBrowserApp);
PjCounterBrowserApp.prototype._initialize = function(){var countDisplay,resetButton,incrementButton,$_self_$=this;PjFileBasedBrowserApp.prototype._initialize.call(this);this.counter=PjCounter._new();this.controller=PjCounterController._new();countDisplay=this._countDisplay();resetButton=this._resetButton();incrementButton=this._incrementButton();$asNil$(this.controller)._counter_(this.counter);$asNil$(this.controller)._updateDisplayBlock_(function(newCount){return $asNil$(countDisplay)._innerHTML_(newCount)});$asNil$(resetButton)._addEventListener_block_("click",function(){return $asNil$($_self_$.controller)._reset()});$asNil$(incrementButton)._addEventListener_block_("click",function(){return $asNil$($_self_$.controller)._increment()});return this}
PjCounterBrowserApp.prototype._countDisplay = function(){return this._domElementAt_("countDisplay")}
PjCounterBrowserApp.prototype._resetButton = function(){return this._domElementAt_("resetButton")}
PjCounterBrowserApp.prototype._incrementButton = function(){return this._domElementAt_("incrementButton")}
PjCounterBrowserApp.__proto__._appJsSubFolder = function(){return "js"}
Smalltalk._registerDnuForAll_(["%",",","=","CLOSED","OPEN","abs","add:","addAll:","addEventListener:block:","addLast:","adoptInstance:","allButFirst:","allButLast:","allSubclassesDo:","apply:with:","arguments","as:","asCharacter","asString","asciiValue","associationsDo:","at:","at:put:","basicNew","basicNew:","basicNew:with:","basicNew:with:with:","basicNew:with:with:with:","basicNew:with:with:with:with:","call:","call:with:","call:with:with:","call:with:with:with:","canUnderstand:","class","className","close","collect:","connectTo:","connectToUrl:","copyFrom:to:","count","count:","countDisplay","counter","counter:","cull:","currentInstance","detect:ifFound:ifNone:","do:","domElementAt:","domElementAt:setAttribute:to:","emptyJavascriptObject","ensure:","error:","errorNotFound:","even","findIndex:","fractionPart","getElementById:","handleDNU:for:","host","ifTrue:ifFalse:","includesKey:","increment","incrementButton","indexOf:","inheritsFrom:","initNilInJs","initObject","initThrowInJs","initWebSocket","initialize","innerHTML:","instVarNamed:","instVarNamed:put:","installDNU:arguments:selector:js:for:else:","integerPart","isEmpty","isLetter","js_apply:args:","js_call:","js_call:with:","js_charAt:","js_charCodeAt:","js_defineProperty:field:properties:","js_forEach:","js_fromCharCode:","js_hasOwnProperty:","js_join:","js_log:","js_parse:","js_pop","js_push:","js_shift","js_split:","js_substring:","js_substring:to:","js_toLowerCase","js_toString","js_toUpperCase","key","key:","key:value:","keysAndValuesDo:","keysDo:","ln","log:","makeDNU:","makeGetter:","makeJavascriptSelector:","makeSetter:","makeSubclass","max:","messageClass:","messageText:","metaclassClass:","metaclassOf:","min:","name","new","new:","newFrom:","nilIfUndefined","nilInJs:","nilTestFunctionName","not","notNil","ofSize:","onClose:","onError:","onMessage:","onOpen:","printString","propertySet:","prototype","querySelector:","readyState","registerDnu:","remove:ifAbsent:","removeAt:","replaceFrom:to:with:startingAt:","reset","resetButton","rounded","selector","setAttribute:to:","sign","signal","signal:","size","species","start","stop","subclassResponsibility","subclasses","subclassesDo:","subscribeToDeviceEvents","superclass","throwFunction","throwFunctionName","to:","to:by:do:","to:do:","truncated","typeof","updateDisplay","updateDisplayBlock","updateDisplayBlock:","value","value:","value:value:","valuesDo:","whileFalse:","whileTrue:","with:","withIndexDo:","yourself"]);
...
(function(appClass,webSocketDelegateClass,url){return function(){$asNil$(appClass)._start();return $asNil$(webSocketDelegateClass)._connectDefaultToUrl_(url)}})(PjCounterBrowserApp,PjEvaluatorWebsocketDelegate,"ws://localhost:3210/javascript-bridge")();
